...
## 🚦 교통 신호 탐지 최적화 (SIFT 기반)

### 🔍 기존 방식의 한계
- 단순한 HSV 색상 기반 탐지는 **조명 조건, 반사, 그림자**에 매우 민감했습니다.
- 특히 **노란불 점멸**이나 **빨간불 그림자**, **녹색+사람 아이콘**처럼 색상이 혼합된 상황에서 오탐지 발생률이 높았습니다.

---

### 🧠 개선: SIFT 기반 Keypoint Matching 방식

- **SIFT(Scale-Invariant Feature Transform)** 를 사용하여 **조도·회전·크기 변화에 강인한 특징점 기반 매칭**을 수행했습니다.
- 각 교통신호 이미지(총 9종류, 아래 참고)를 사전 등록된 템플릿으로 사용하고,
