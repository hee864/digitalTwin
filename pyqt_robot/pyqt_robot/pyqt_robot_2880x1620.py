...
class MapViewer(QGraphicsView):
    def __init__(self, odom_listener):
        ...
        # Camera view label (좌상단)
        self.camera_label = QLabel(self)
        self.camera_label.setGeometry(20, 20, 960, 720)
        ...
        self.plot_widget.setGeometry(1000, 20, 800, 350)
        self.plot_widget.setBackground('w')
        self.plot_widget.setTitle("Lin_x Vel", color='k', size='12pt')
        ...
        self.debug_plot_widget.setGeometry(1000, 390, 800, 350)
        self.debug_plot_widget.setBackground('w')
        self.debug_plot_widget.setTitle("Ang_Z Vel & Error(1/10 Scale)", color='k', size='12pt')
        ...
        self.pitch_plot_widget.setGeometry(1000, 750, 800, 200)  # 기존 밑에 위치, 높이 작게 설정
        self.pitch_plot_widget.setBackground('w')
        self.pitch_plot_widget.setTitle("Pitch", color='k', size='12pt')
        ...
        self.traffic_label.setStyleSheet("color: white; font-size: 48px;")
        self.traffic_label.move(20, 180)
        self.traffic_label.resize(1000, 60)

        # --- 사람 감지 메시지 라벨 추가 ---
        self.person_label = QLabel(self)
        self.person_label.setStyleSheet("color: white; font-size: 48px;")
        self.person_label.move(20, self.height() - 50)
        self.person_label.resize(1000, 60)
    ...
    def resizeEvent(self, event):
        ...
        self.traffic_label.move(120, self.height() - 580)
        self.person_label.move(120, self.height() - 500)
        self.reset_view()
        self.update_robot_position(self.current_x, self.current_y, self.current_theta)
