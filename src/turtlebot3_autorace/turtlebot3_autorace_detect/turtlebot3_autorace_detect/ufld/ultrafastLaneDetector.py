...
from turtlebot3_autorace_detect.ufld.model import parsingNet
...
class UltrafastLaneDetector():
	...
	def process_output(output, cfg):
		...
		# Ensure consistent lengths for lanes_points and lanes_detected
		# If there are no points detected, assign [[0, 0]] to lanes_points
		lanes_points = [lane_points if len(lane_points) > 0 else [[0, 0]] for lane_points in lanes_points]
		lanes_detected = [True if len(lane_points) > 0 else False for lane_points in lanes_points]
